...
1.　[Releases](https://github.com/TakashiYoshinaga/360-to-RealityScan/releases) から **`MetashapeToRS.exe`** をダウンロードし、ダブルクリックで起動します（Anaconda・Python 不要）
...
![Metashape to RealityScan](https://raw.githubusercontent.com/TakashiYoshinaga/360-to-RealityScan/main/Documents/Images/036-MetaShapeConverter_3.jpg)
