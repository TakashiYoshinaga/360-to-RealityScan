...
1.　Download **`MetashapeToRS.exe`** from [Releases](https://github.com/TakashiYoshinaga/360-to-RealityScan/releases) and launch it by double-clicking (no Anaconda or Python required)
